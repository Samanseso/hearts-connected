...
export function ScenarioChecklist({ completedScenarios }: ScenarioChecklistProps) {
    return (
        <div className="space-y-2">
            {PLAYABLE_SCENARIO_IDS.map((scenarioId) => {
                ...
                return (
                    <div
                        key={scenarioId}
                        className="flex items-center gap-3 rounded-[18px] bg-white/70 px-3 py-2 text-[13px] text-[#503848] shadow-[0_8px_20px_rgba(92,54,75,0.12)]"
                    >
                        <div
